...
class BurstSRDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, opt, burst_size=8, crop_sz=80, center_crop=False, random_flip=True, split='train'):
        """
        args:
        ...
        """
        root = opt["dataset"]["real_dataset_path"]
    ...
    def __getitem__(self, index):
        ...
        # print(burst[0])
        burst = burst.reshape((self.burst_size * 4 , self.crop_sz, self.crop_sz)) # yasue
